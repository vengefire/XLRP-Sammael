...
namespace Framework.Logic.Queue.Config.Queue
{
    ...
    public class MessageQueueElement : ConfigurationElement
    {
        ...
        {
            get => (string) this["messageQueueHostServerName"];
        ...
        {
            get => (string) this["multicastAddress"];
        ...
        {
            get => Convert.ToBoolean(this["isTransactional"]);
        ...
        {
            get => Convert.ToBoolean(this["auditActivity"]);
        ...
        {
            get => Convert.ToBoolean(this["defaultRecoverable"]);
