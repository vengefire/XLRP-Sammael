...
namespace Framework.Logic.Queue.Config.QueueProcessor
{
    ...
    public class QueueProcessorElement : ConfigurationElement
    {
        ...
        {
            get => Convert.ToMessageProcessingMode(this["messageProcessingMode"]);
        ...
        {
            get => System.Convert.ToInt32(this["numWorkers"]);
        ...
        {
            get => (string) this["messageLogicHandler"];
