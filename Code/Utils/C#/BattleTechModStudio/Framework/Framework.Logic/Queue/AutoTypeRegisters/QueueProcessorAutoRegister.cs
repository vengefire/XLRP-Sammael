...
namespace Framework.Logic.Queue.AutoTypeRegisters
{
    public static class QueueProcessorAutoRegister
    {
        ...
        public static void RegisterQueueProcessorsAndNodes(
            IEnumerable<Type> queueTypes,
            IEnumerable<Type> logicTypes,
            IWindsorContainer container)
        {
            var registrations = new List<IRegistration>();
        ...
        private static IRegistration[] RegisterQueueProcessorAndNode(
            Type queueType,
