...
namespace Framework.Logic.Tasks.Config.Scheduled
{
    public class ScheduledTaskElement : ConfigurationElement
    {
        ...
        {
            get => Convert.ToDateTime(this["time"]);
            set => this["time"] = value;
        }
        ...
        public int Month
        {
            get => Convert.ToInt32(this["month"]);
        ...
        {
            get => (string) this["dayScheduleType"];
        ...
        {
            get => TimeSpan.Parse(this["interval"].ToString());
